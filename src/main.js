...
exports.globalApply = void 0;
var core_1 = require("@nestjs/core");
var swagger_1 = require("@nestjs/swagger");
var app_module_1 = require("./app.module");
var expressListRoutes = require("express-list-routes");
var globalApply = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        app.setGlobalPrefix('api/');
        return [2 /*return*/];
    });
}); };
exports.globalApply = globalApply;
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document, server, router;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule)];
                case 1:
                    app = _a.sent();
                    return [4 /*yield*/, (0, exports.globalApply)(app)];
                case 2:
                    _a.sent();
